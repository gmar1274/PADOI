...
import com.mashape.unirest.http.Unirest;
    ...
    public class SpotifyHTTPRequest  extends AsyncTaskLoader<String> {

        // We hold a reference to the Loader’s data here.
        private String mData;
        private String token;

        public SpotifyHTTPRequest(Context context, String accessToken) {
        ...
        public String loadInBackground() {
            try {
                HttpResponse response = Unirest.get("https://api.spotify.com/v1/me")
