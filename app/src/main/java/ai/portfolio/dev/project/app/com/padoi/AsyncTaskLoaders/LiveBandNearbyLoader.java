...
/**
 * This class makes an api call to firebase and fetches all nearby bandUsers who are LIVE (have their geolocation public)
 */
public class LiveBandNearbyLoader extends AsyncTaskLoader<List<BandUser>> {

        // We hold a reference to the Loader’s data here.
        private List<BandUser> mData;
        private Location userLoc;

        public LiveBandNearbyLoader(Context context, Location userLoc) {
    ...
    public void swap(List<BandUser> data) {
        this.mData=data;
    }
